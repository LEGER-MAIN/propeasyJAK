<?php
/**
 * Vista: Perfil del Agente
 * PropEasy - Sistema Web de Venta de Bienes Raíces
 * 
 * Esta vista permite a los agentes gestionar su perfil y ver sus actividades
 */
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Mi Perfil de Agente</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white shadow rounded-lg">
                    ...
                    <form action="/agente/perfil" method="POST" class="p-6 space-y-6">
            ...
            <div class="lg:col-span-1">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="text-center">
                                ...
                                <div class="text-sm text-gray-600">Vendidas</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-primary-600">
                            ...
                            <div class="text-center">
                                <div class="text-2xl font-bold text-primary-600">
                                    <?= number_format($stats['calificacion_promedio'] ?? 0, 1) ?>
                                </div>
                ...
                <div class="bg-white shadow rounded-lg">
                    ...
                    <div class="p-6 space-y-3">
                        <a href="/agente/perfil-publico" class="block w-full text-left px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md transition-colors">
                            <i class="fas fa-user-circle mr-3 text-primary-600"></i>
                            Mi Perfil Público
                        </a>
                        <a href="/properties/agent/list" class="block w-full text-left px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md transition-colors">
                            <i class="fas fa-list mr-3 text-primary-600"></i>
                            Mis Propiedades
                        </a>
                        <a href="/agente/propiedades-pendientes" class="block w-full text-left px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md transition-colors">
                            <i class="fas fa-clock mr-3 text-primary-600"></i>
                            Propiedades Pendientes
                        </a>
                        <a href="/properties/create" class="block w-full text-left px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md transition-colors">
                            <i class="fas fa-plus mr-3 text-primary-600"></i>
                            Publicar Propiedad
                        </a>
