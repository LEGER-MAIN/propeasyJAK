 ...
 * 
 * Esta vista permite a los usuarios ver y editar su información personal
 */
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white shadow rounded-lg">
                    ...
                    <form action="/profile" method="POST" class="p-6 space-y-6">
                        ...
                        <!-- Ciudad y Sector (si están disponibles) -->
                        <?php if (isset($user['ciudad']) || isset($user['sector'])): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                ...
                <div class="bg-white shadow rounded-lg">
                    ...
                    <div class="p-6 space-y-3">
                        <?php if (hasRole(ROLE_AGENTE)): ?>
                            <a href="/agente/perfil" class="block w-full text-left px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-md transition-colors">
